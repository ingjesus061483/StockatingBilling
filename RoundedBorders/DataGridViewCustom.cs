...
namespace RoundedBorders
{
    public class DataGridViewCustom:DataGridView
    {
        ...
        private GraphicsPath GetArtanPath(RectangleF rectangle, float radius)
        {
            ...
            graphicsPath.AddArc(rectangle.Width, rectangle.Height - radius, radius, radius, 0, 90);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            LinearGradientBrush brushArtan = new LinearGradientBrush(ClientRectangle, this.GradientTopColor,
